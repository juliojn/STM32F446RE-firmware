/*
 * Blinking led usando el manejador de interrupciones
 */
...
main (void)
{
    ...
    nvic_set_handler(nvic_src_sai_2, blinking_led);
    nvic_enable_interrupt(nvic_src_sai_2);
    nvic_set_priority(nvic_src_wwdg, excep_priority_15);
    nvic_force_interrupt(nvic_src_sai_2);
}
